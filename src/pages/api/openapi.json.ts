					...
					parameters: [
						{
							...
							description:
								"Locale for content. Returns translated content if available, otherwise falls back to English.",
						},
					],
					responses: {
						"200": {
								...
								schema: {
									...
									properties: {
										...
										language: {
											...
											enum: ["en", "pt"],
											description:
												"Preferred language for course content and agent responses. Typically set automatically from the page locale at enrollment time.",
											example: "en",
										},
									},
								},
