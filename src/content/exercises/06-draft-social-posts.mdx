...
In this exercise, you'll use OpenCode to brainstorm and draft social media posts, then send them to [Typefully](https://typefully.com) where you can review and publish them. Typefully supports five platforms: X (Twitter), LinkedIn, Threads, Bluesky, and Mastodon — you can post to any combination from a single draft.
...
<AgentPrompt title="Draft social posts" prompt='Let&#39;s work on the "Draft social posts" exercise together!' />

## Prerequisites

This exercise requires the **Typefully skill** for OpenCode. If you completed the [Skills lesson](/lessons/skills), you know how to install skills. Run:
