...
order: 3
agentInstructions: "Verify completion by reading ~/.config/opencode/opencode.jsonc and confirming it contains a \"$schema\" key pointing to \"https://opencode.ai/config.json\" and \"permission\": {\"*\": \"allow\"}."
---
