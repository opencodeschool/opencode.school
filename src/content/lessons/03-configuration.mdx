...
OpenCode will substitute your actual student ID when it creates the file. The instructions URL lets OpenCode fetch your school enrollment at the start of every session, so it knows who you are even when you're working on something unrelated.
