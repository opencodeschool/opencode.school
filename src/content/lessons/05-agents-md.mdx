...
order: 5
acceptanceCriteria: "The file ~/.config/opencode/AGENTS.md exists and contains at least one meaningful custom instruction for the agent (not just a placeholder or empty file)."
---
