...
<figure class="text-center my-8">
  <img src="/images/allow-always-keyboard.jpg" alt="A novelty Apple keyboard with three oversized keys: Allow once, Allow always, and Reject" class="rounded-lg mx-auto" />
