...
order: 4
acceptanceCriteria: "The global config file ~/.config/opencode/opencode.jsonc has a \"permission\" object with at least two granular permission rules (not just the wildcard \"*\": \"allow\"). For example, separate rules for file reads, file writes, and shell commands."
---
