...
Even though MCP servers are managed in the global OpenCode config, you don't have to edit the file yourself — you can just ask OpenCode to do it. Try asking it to add the following to your `~/.config/opencode/opencode.json`:
