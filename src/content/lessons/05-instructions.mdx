...
order: 5
agentInstructions: "Verify completion by reading ~/.config/opencode/AGENTS.md and confirming it exists with at least one meaningful custom instruction (not just a placeholder or empty file)."
---
